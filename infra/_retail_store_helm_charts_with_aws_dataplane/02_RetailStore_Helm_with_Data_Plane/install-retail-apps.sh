...
helm install catalog oci://public.ecr.aws/i5b4r2o0/retail-store-catalog-chart \
  --version 1.0.0 \
...
helm install cart oci://public.ecr.aws/i5b4r2o0/retail-store-cart-chart \
  --version 1.0.0 \
  -f values-cart.yaml
sleep 10
...
helm install checkout \
  oci://public.ecr.aws/i5b4r2o0/retail-store-checkout-chart \
  --version 1.0.0 \
...
helm install orders oci://public.ecr.aws/i5b4r2o0/retail-store-orders-chart \
  --version 1.0.0 \
...
helm install ui oci://public.ecr.aws/i5b4r2o0/retail-store-ui-chart \
  --version 1.0.0 \
  -f values-ui.yaml
sleep 10
